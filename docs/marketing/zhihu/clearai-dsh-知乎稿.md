...
```
ui/lib/domain-language.js        740 行   判据纯函数
...
preset/plugins/prompts.js         370 行   提示词段
```

总量 13,000 行出头。三条架构纪律分别对应第 3 节的三条可信判据：
