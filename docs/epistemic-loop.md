...
- **Knowledge work is native, not another mode:** once a goal carries registered hypotheses, the system enters knowledge mode by a structural test (preflight what is known, read out the gaps, gate a core conclusion that has no typed form before close); ordinary Q&A never enters and adds nothing.
